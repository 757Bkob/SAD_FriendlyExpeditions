return PlaceObj('ModDef', {
	...
	'last_changes', "1.1.2 Minor fix\n\n#1 Bugfix: Fixed tames spawned from expeditions having (tamed) as their name after spawning.\n\n#2 QoL: All print statements moved to debug logging.\n\nAdded git link and translation table links to description.",
	'dependencies', {
